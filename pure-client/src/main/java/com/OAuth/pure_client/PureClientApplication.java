...
public class PureClientApplication {
	...
	@Bean
	public OAuth2AuthorizedClientManager oAuth2AuthorizedClientManager(ClientRegistrationRepository repos,
	...
	@Bean
	public CommandLineRunner run(OAuth2AuthorizedClientManager manager, RestTemplate rest,
		...
		return args -> {
			...
			System.out.print("Response from Service2:  " + response);
		};
